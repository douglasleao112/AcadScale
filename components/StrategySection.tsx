...
const StrategySection: React.FC = () => {
  ...
  // Suavizando o progresso do scroll para transformações fluidas
  ...
  return (
    ...
    >
      {/* 1. Background Grid (Xadrez Técnico) */}
      ...
      {/* 2. Conteúdo de Texto (Foreground - Acima de tudo) */}
      <div className="relative z-10 max-w-7xl mx-auto text-center space-y-10">
        ...
        >
          ...
          <motion.p 
            ...
            className="text-5xl md:text-8xl lg:text-[11rem] font-serif-italic text-white italic leading-none drop-shadow-[0_0_60px_rgba(59,130,246,0.5)]"
          >
            E não achismo!
          </motion.p>
        </motion.div>
        ...
        >
          <div className="h-20 w-[1px] bg-gradient-to-b from-blue-400 to-transparent mx-auto" />
        </motion.div>
      </div>
    </section>
  );
