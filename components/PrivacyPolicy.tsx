      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="bg-neutral-900/40 border border-white/5 p-8 md:p-12 rounded-[2.5rem] backdrop-blur-sm shadow-[0_20px_70px_rgba(0,0,0,0.35)]">
            ...
            <p>
              Utilizamos cookies e tecnologias similares, como pixels do Facebook e Google Tag Manager, para entender como você interage com nossa página. Isso nos ajuda a otimizar o carregamento e apresentar conteúdos mais relevantes para o seu perfil.
            </p>
          </div>
